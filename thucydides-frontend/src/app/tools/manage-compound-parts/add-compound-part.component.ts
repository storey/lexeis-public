...
@Component({
  selector: 'add-compound-part',
  templateUrl: './add-compound-part.component.html',
  styleUrls: [ './add-compound-part.component.css', '../form-styles.css' ]
})

export class AddCompoundPartComponent {
  public categoryName: string = "Compound Part";
  public ADD_RESULT_LINK: string = "/compound/";
  ...
  onSubmit(form: any): void {
    ...
    if (!form.valid) {
      ...
      let observation = this.backendService.addCompound(formData);
