...
export class RootGroupComponent{
  public myGroup: RootGroup;
  public isLoading: boolean = true;
  public listTitle = "Entries of This Root Type:";
  ...
  update(params: ParamMap) {
    this.isLoading = true;
    this.backendService.getRootGroup(params).subscribe(results => {
